            ...
            <div className="my-5">
              <div className="text-lg font-bold">
                ...
                <div className="grid grid-cols-3 my-5">
                  <div className="col-span bg-gray-200 mr-2 border-2 border-black rounded-lg h-20"></div>
                  <div className="col-span bg-gray-200 mx-2 border-2 border-black rounded-lg h-20"></div>
                  <div className="col-span bg-gray-200 ml-2 border-2 border-black rounded-lg h-20"></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="flex flex-1">
                <div className="flex-auto py-2">
                  <Input
                    ...
                    className="h-10 bg-gray-100 border-l-2 border-t-2 border-b-2 border-r-0 border-yellow-light rounded-l-lg rounded-tr-none rounded-br-none hover:border-yellow-light focus:border-yellow-light"
                  />
                </div>
                <div className="py-2">
                  <Button
                    className="bg-yellow-light text-black font-bold border-r-2 border-t-2 border-b-2 border-l-0 border-yellow-light rounded-r-lg rounded-tl-none rounded-bl-none hover:bg-yellow-light hover:border-yellow-light hover:text-black focus:border-yellow-light focus:bg-yellow-light focus:text-black"
                    size="large"
                  >
                    Đăng ký
                  </Button>
