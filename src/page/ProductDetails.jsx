          ...
          <div className="py-8">
            <div className="grid grid-cols-3 gap-20">
              <div className="col-span">
                <div className="mb-8">
                  {/* {product?.image[selectedThumb] ? (
                    <img
                      src={product?.image[selectedThumb]}
                      alt="ThumbNails"
                    ></img>
                  ) : null} */}
                </div>
              ...
              <div className="col-span-2 text-base">
                ...
                <div className="flex mb-4">
                  <p className="mt-3 mr-8 font-bold">Chọn màu cho sản phẩm: </p>
                  <Radio.Group
                    className="mt-1"
                ...
                <div className="flex">
                  <div className="flex items-center mr-12 font-bold">Chọn số lượng: </div>
                  {type[selectedType]?.quantity > 0 ? (
                    ...
                    <div className="flex items-center text-xl text-red-500 font-bold">Hết hàng</div>
                  )}
                </div>
